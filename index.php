...
<html lang="en">
  ...
  <head>
    ...
    <title>Shakti Naik - Full Stack Developer</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Shakti Naik</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 mb-5 mb-lg-0">
            ...
            <p class="lead mb-0">Kalarahanga, Patia
              <br>Bhubaneswar, 751024</p>
          </div>
          <div class="col-md-4 mb-5 mb-lg-0">
          ...
          <div class="col-md-4">
            <h4 class="text-uppercase mb-4">Total Page Viewed</h4>
            <p class="lead mb-0"> <?php print $views; ?> </p>
          </div>
        </div>
      </div>
    </footer>
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container">
        <small>Copyright &copy; shaktinaik.com 2018</small>
      </div>
    </div>
